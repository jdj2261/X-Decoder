...
coco_train_annot = json.load(
    open(os.path.join(coco_root, "annotations/instances_train2017.json"))
)
coco_train_id = []
image_annot = {}
...
refg = REFER(data_root=ref_root, dataset="refcocog", splitBy="umd")
...
json.dump(
    outputs, open(os.path.join(coco_root, "annotations/refcocog_umd_train.json"), "w")
)
