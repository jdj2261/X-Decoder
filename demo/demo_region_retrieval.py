...
def main(args=None):
    ...
    model.model.sem_seg_head.predictor.lang_encoder.get_text_embeddings(
        ["background", "background"], is_eval=False
    )
    ...
    with torch.no_grad():
        ...
        model.model.sem_seg_head.predictor.lang_encoder.get_text_embeddings(
            text, is_eval=False, name="caption", prompt=False
        )
        t_emb = getattr(
            model.model.sem_seg_head.predictor.lang_encoder,
            "{}_text_embeddings".format("caption"),
        )
